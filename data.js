const languageContent = {
  en: {
    ...
    course02: 'Solutions and prospects «emotional leadership» («BTG»);',
    course03: 'Financial accounting 1 (IFRS) («Elcon»);',
    course03: 'Analytics in logistics («Analitic Butique»).',
    title08: 'Languages',
    ...
    project03:
      '[The application helps to manage books: add books manually, random from local file.JSON, and random with API, make books favorite filter them by name, author and favorites, delete.]',
  },
  cz: {
    title01: 'Účel práce',
    firstName: 'Denys',
  ...
  ua: {
    ...
    course02: 'рішення та перспективи «емоційне лідерство» («BTG»);',
    course03: 'Фінансовий облік 1 (IFRS) («Elcon»);',
    course04: 'аналітика в логістиці («Analitic Butique»).',
    title08: 'Мови',
    lang01: 'українська (рідна);',
    lang02: 'англійська (B2);',
    lang03: 'чеська (A1).',
    title09: 'Проєкти',
    ...
    project03:
      '[Допомагає керувати переліком книг: додавати книги вручну, обирати випадкові книги з локального файлу JSON і випадково за допомогою API, позначати обрані книги, фільтрувати їх за назвою, автором і з обраних, видаляти.]',
  },
};
